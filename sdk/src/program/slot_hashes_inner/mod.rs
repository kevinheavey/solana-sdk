...
//!
//! The sysvar ID is declared in [`crate::program::sysvar::slot_hashes`].
//!
//! [`crate::program::sysvar::slot_hashes`]: https://docs.rs/solana-program/latest/solana_program/sysvar/slot_hashes/index.html

pub mod sysvar;

use {
    super::hash_inner::Hash,
    std::{
        iter::FromIterator,
        ops::Deref,
